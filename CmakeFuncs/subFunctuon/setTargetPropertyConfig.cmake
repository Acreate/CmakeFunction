...
function( set_target_BIN_out_path_property target_obj out_path )
	set_target_properties( "${target_obj}" PROPERTIES
		...
		# RUNTIME_OUTPUT_DIRECTORY "$<1:${out_path}>"
		# RUNTIME_OUTPUT_DIRECTORY_MINSIZEREL "$<1:${out_path}>"
		# RUNTIME_OUTPUT_DIRECTORY_RELWITHDEBINFO "$<1:${out_path}>"
		# RUNTIME_OUTPUT_DIRECTORY_RELEASE "$<1:${out_path}>"
		# RUNTIME_OUTPUT_DIRECTORY_DEBUG "$<1:${out_path}>"
	)
	# set( CMAKE_RUNTIME_OUTPUT_DIRECTORY_DEBUG ${out_path} PARENT_SCOPE )
	# set( CMAKE_RUNTIME_OUTPUT_DIRECTORY_RELEASE ${out_path} PARENT_SCOPE )
	# set( CMAKE_RUNTIME_OUTPUT_DIRECTORY_RELWITHDEBINFO ${out_path} PARENT_SCOPE )
	# set( CMAKE_RUNTIME_OUTPUT_DIRECTORY_MINSIZEREL ${out_path} PARENT_SCOPE )
	
	# set( CMAKE_LIBRARY_OUTPUT_DIRECTORY_DEBUG ${out_path} PARENT_SCOPE )
	# set( CMAKE_LIBRARY_OUTPUT_DIRECTORY_RELEASE ${out_path} PARENT_SCOPE )
	# set( CMAKE_LIBRARY_OUTPUT_DIRECTORY_RELWITHDEBINFO ${out_path} PARENT_SCOPE )
	# set( CMAKE_LIBRARY_OUTPUT_DIRECTORY_MINSIZEREL ${out_path} PARENT_SCOPE )
	
	# set( CMAKE_ARCHIVE_OUTPUT_DIRECTORY_DEBUG ${out_path} PARENT_SCOPE )
	# set( CMAKE_ARCHIVE_OUTPUT_DIRECTORY_RELEASE ${out_path} PARENT_SCOPE )
	# set( CMAKE_ARCHIVE_OUTPUT_DIRECTORY_RELWITHDEBINFO ${out_path} PARENT_SCOPE )
	# set( CMAKE_ARCHIVE_OUTPUT_DIRECTORY_MINSIZEREL ${out_path} PARENT_SCOPE )
endfunction( )
